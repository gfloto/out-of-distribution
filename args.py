...
def get_args():
    ...
    parser.add_argument('--test_name', default='first')
    ...
    parser.add_argument('--tilt', type=float, default=20., help='tilt of spheres')
    parser.add_argument('--lat_dim', type=int, default=64*2**2, help='latent dimension')
    parser.add_argument('--spheres', type=int, default=16, help='number of spheres in product space')
    parser.add_argument('--beta', type=float, default=0.01, help='beta for beta-vae')
    parser.add_argument('--recon', default='l1', help='loss, either l2 or l1')
    parser.add_argument('--percept_lmda', type=float, default=1, help='perceptual loss weight')
    ...
    assert args.percept_lmda >= 0, 'perceptual loss weight must be non-negative'
